...
<head>
  <meta charset="UTF-8">
  <title>Alterar Nome - MyWallet</title>
...
<body>
  <form class="form-box" action="alterarNome" method="post">
    <h2>Alterar Nome</h2>
    <div>
      <label for="novo-nome">Novo nome:</label>
      <input type="text" id="novo-nome" name="novo_nome" placeholder="Digite seu novo nome">
    </div>
